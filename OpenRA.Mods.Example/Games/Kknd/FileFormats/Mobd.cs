...
namespace OpenRA.Mods.Example.Games.Kknd.FileFormats
{
	public class Mobd
	{
		...
		public readonly Dictionary<uint, MobdAnimation> Animations = new();
		public readonly uint[] OrderedAnimations;
		public readonly Dictionary<uint, MobdFrame> Frames = new();
		public readonly Dictionary<uint, uint[]> RegionsLists = new();
		public readonly Dictionary<uint, MobdRegion> Regions = new();
		public readonly Dictionary<uint, MobdPoint[]> Points = new();

		public readonly Dictionary<uint, MobdImageVariation> ImageVariations = new();

		public readonly Dictionary<uint, MobdImage> Images = new();
		public readonly Dictionary<uint, MobdPalette> Palettes = new();
